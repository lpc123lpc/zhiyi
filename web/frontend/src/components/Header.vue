      ...
      <el-col :span="24">
        ...
        <div class="headBox">
          <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" :router="true">
            <el-menu-item index="/Home"><i class="fa fa-wa fa-home"></i> 疫苗接种</el-menu-item>
            <el-menu-item index="/Reward"><i class="fa fa-wa fa-cny"></i> 感染情况</el-menu-item>
            <el-menu-item index="/Friendslink"><i class="fa fa-wa fa-users"></i> 出行建议</el-menu-item>
            <el-menu-item index="/Message"><i class="fa fa-wa fa-pencil"></i> 新闻资讯</el-menu-item>
            <el-menu-item index="/Aboutme"><i class="fa fa-wa fa-vcard"></i> 反馈&建议</el-menu-item>
            <!--<div index="" class="pcsearchbox">
              <i class="el-icon-search pcsearchicon"></i>
              <div class="pcsearchinput" :class="input?'hasSearched':''">
                <el-input placeholder="搜索" icon="search" v-model="input" :on-icon-click="searchEnterFun" @keyup.enter.native="searchEnterFun" @change="searchChangeFun"></el-input>
              </div>
            </div>-->
            <div index="" class="pcsearchbox">
              <i class="el-icon-search pcsearchicon"></i>
        ...
        <!--<div class="mobileBox">
          <div class="hideMenu">
            ...
            <div class="searchBox">
              <el-input placeholder="" icon="search" v-model="input" @keyup.enter.native="searchEnterFun" :on-icon-click="searchEnterFun" @change="searchChangeFun"></el-input>
            </div>
          </div>
        </div>-->
      </el-col>
